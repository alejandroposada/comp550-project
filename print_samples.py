...
def main():
    ...
    print('tags: z vs z prime                = {}'.format(t1.pvalue))
    print('tags z_prime NONE vs z_prime SBAR = {}'.format(t2.pvalue))
    print('tags z_prime NONE vs z_prime PP   = {}'.format(t3.pvalue))
    print('tags z_prime NONE vs z_prime ADJP = {}'.format(t4.pvalue))
    print('tags z_prime NONE vs z_prime QP   = {}'.format(t5.pvalue))
    print('tags z_prime NONE vs z_prime WHNP = {}'.format(t6.pvalue))
    print('tags z_prime NONE vs z_prime ADVP = {}'.format(t7.pvalue))
